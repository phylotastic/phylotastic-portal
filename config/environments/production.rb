Rails.application.configure do
  ...
  Rails.application.configure do
    ...
    config.x.ete_js = "https://phylo.cs.nmsu.edu:8080/ete.js"
    config.x.ete_css = "https://phylo.cs.nmsu.edu:8080/ete.css"
    ...
    config.x.sv_tc = "http://phylo.cs.nmsu.edu:5013/phylotastic_ws/tc/common_names"
  end
end
