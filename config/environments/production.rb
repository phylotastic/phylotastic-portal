Rails.application.configure do
  ...
  Rails.application.configure do
    ...
    config.x.sv_Taxon_country_species = "https://phylo.cs.nmsu.edu/phylotastic_ws/ts/country_species?taxon="
    config.x.sv_Taxon_genome_species = "https://phylo.cs.nmsu.edu/phylotastic_ws/ts/ncbi/genome_species?taxon="
    config.x.sv_Taxon_all_species = "https://phylo.cs.nmsu.edu/phylotastic_ws/ts/all_species?taxon="
    ...
    config.x.sv_Taxon_popular_species = "https://phylo.cs.nmsu.edu/phylotastic_ws/ts/popular_species?taxon="
